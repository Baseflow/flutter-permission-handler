...
abstract class ActivityTestHostApi {
  ...
  void requestPermissions(String activityInstanceId, List<String?> permissions, int requestCode);
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          assert(arg_requestCode != null,
              'Argument for dev.flutter.pigeon.permission_handler_android.ActivityHostApi.requestPermissions was null, expected non-null int.');
          api.requestPermissions(arg_activityInstanceId!, arg_permissions!, arg_requestCode!);
          return <Object?>[];
        });
      }
    }
